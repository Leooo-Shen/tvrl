# common utility functions; mostly copy paste from timm
...
class Attention(nn.Module):
    ...
    def forward(self, x, attn_mask=None):
        ...
        # apply attention attn_mask, 1 indicates a value should be attended to, 0 indicates a padded value
        if attn_mask is not None:
            # to be compatible with [bs, t, t] triangular causal mask
            if attn_mask.dim() == 3:
